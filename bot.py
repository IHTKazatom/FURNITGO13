...
SUPPLIER_PHONE = "+7 747 097 7434"             # ← телефон поставщика
...
CATALOG = {
    "Ручки": {
        "emoji": "🔧",
        "items": [
            {"name": "Ручки-скобы",       "photo": "https://boyard.ru/upload/iblock/b2a/b2a7c4b8e6a5a7e5c8f0b2a4d6e8c9f0.jpg"},
            {"name": "Ручки-кнопки",      "photo": "https://boyard.ru/upload/iblock/a1b/a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6.jpg"},
            {"name": "Торцевые ручки",    "photo": ""},
"https://www.boyard.biz/catalog/handles/rpk001.html"},
            {"name": "Профильные ручки",  "photo": ""},
            {"name": "Ручки-ракушки",     "photo": ""},
            {"name": "Рейлинговые ручки", "photo": ""},
            {"name": "Врезные ручки",     "photo": ""},
        ]
    },
    "Петли": {
        "emoji": "🔩",
        "items": [
            {"name": "Петли NEO",         "photo": ""},
            {"name": "Петли EVO",         "photo": ""},
            {"name": "Накладные",         "photo": ""},
            {"name": "Полунакладные",     "photo": ""},
            {"name": "Вкладные",          "photo": ""},
            {"name": "С доводчиком",      "photo": ""},
            {"name": "Без доводчика",     "photo": ""},
        ]
    },
    "Направляющие": {
        "emoji": "📏",
        "items": [
            {"name": "Шариковые",         "photo": ""},
            {"name": "Роликовые",         "photo": ""},
            {"name": "Скрытого монтажа",  "photo": ""},
            {"name": "Push-to-open",      "photo": ""},
            {"name": "Телескопические",   "photo": ""},
        ]
    },
    "Системы выдвижения": {
        "emoji": "🗄",
        "items": [
            {"name": "Металлобоксы",          "photo": ""},
            {"name": "СТАРТ",                 "photo": ""},
            {"name": "Тонкостенные ящики",    "photo": ""},
            {"name": "Внутренние ящики",      "photo": ""},
        ]
    },
    "Газлифты": {
        "emoji": "⚙️",
    ...
    "Корзины": {
        "emoji": "🧺",
        "items": [
            {"name": "Бутылочницы",      "photo": ""},
            {"name": "Карго",            "photo": ""},
            {"name": "Волшебный уголок", "photo": ""},
            {"name": "Колонны",          "photo": ""},
        ]
    },
    "Сушки": {
        ...
        "items": [
            {"name": "Верхние",         "photo": ""},
            {"name": "Нижние",          "photo": ""},
            {"name": "Двухуровневые",   "photo": ""},
            {"name": "Одноуровневые",   "photo": ""},
        ]
    },
    "Опоры": {
        "emoji": "🦵",
    ...
    "Крепёж": {
        "emoji": "🔨",
        "items": [
            {"name": "Конфирматы",  "photo": ""},
            {"name": "Эксцентрики", "photo": ""},
            {"name": "Шканты",      "photo": ""},
            {"name": "Евровинты",   "photo": ""},
            {"name": "Стяжки",      "photo": ""},
        ]
    },
}
...
async def handle_supplier(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("avail_yes|") or data.startswith("avail_no|"):
        parts = data.split("|")
    ...
    elif data.startswith("reply_client|"):
        order_id = data.replace("reply_client|", "")
        orders = load_orders()
